# Traffic Orchestrator — Java SDK

[![Maven](https://img.shields.io/badge/Maven_Central-2.0.0-C71A36?logo=apachemaven)](https://central.sonatype.com/artifact/io.github.traffic-orchestrator/traffic-orchestrator-sdk)
...
```bash
<!-- Maven -->
Add to pom.xml: io.github.traffic-orchestrator:traffic-orchestrator-sdk:2.0.0
```

```java
TrafficOrchestrator client = new TrafficOrchestrator.Builder()
    .apiKey("sk_live_your_key_here")
    .build();
ValidationResult result = client.validateLicense("LK-xxxx-xxxx-xxxx", "yourdomain.com");
System.out.println(result.isValid() ? "License active" : "License invalid");
```
...
- ?? [Report an Issue](https://github.com/TrafficOrchestrator/java-sdk/issues)
